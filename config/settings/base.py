...
# https://docs.allauth.org/en/latest/account/configuration.html
# ACCOUNT_EMAIL_REQUIRED = True #1 deprecated in django-allauth 65.8.1
# https://docs.allauth.org/en/latest/account/configuration.html
# ACCOUNT_USERNAME_REQUIRED = False #2 deprecated in django-allauth 65.8.1
# https://docs.allauth.org/en/latest/account/configuration.html
...
ACCOUNT_LOGIN_METHODS = {"email"}
# ACCOUNT_USERNAME_REQUIRED = False #3 deprecated in django-allauth 65.8.1
# ACCOUNT_EMAIL_REQUIRED = True #4 deprecated in django-allauth 65.8.1
